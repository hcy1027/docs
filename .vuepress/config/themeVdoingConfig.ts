...
export default <VdoingThemeConfig>{
  ...
  logo: "/assets/img/other.png", // 导航栏Logo
  repo: "ChengyangHu/docs", // 导航栏右侧生成Github链接
  searchMaxSuggestions: 10, // 搜索结果显示最大数
  lastUpdated: "上次更新", // 更新的时间，及前缀文字   string | boolean (取值为git提交时间)
  docsDir: "/", // 编辑的文件夹
  editLinks: true, // 启用编辑
  editLinkText: "帮助我使内容变得更好", // 编辑链接文字
  ...
  social: {
    ...
    icons: [
      ...
      },
      {
        ...
        title: "发邮件",
        link: "mailto:chengyang.hu@foxmail.com",
      },
    ],
  },
  footer: {
